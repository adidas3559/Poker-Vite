...
import { cTestDealCards, cRaiseHandler, cCheckHandler, cCallHandler, cFoldHandler } from '../controllers/game';
...
const GameView = () => {
  ...
  const drawHandler = () => {
    // use game class
    const { mDealerIndex, mPlayers, mPot, mCurrentPlayerIndex, mCurrentBet, mGameState, mTableCards } = cTestDealCards();
